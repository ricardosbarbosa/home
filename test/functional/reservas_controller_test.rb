...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { area_id: @reserva.area_id, data: @reserva.data, status: @reserva.status, user_id: @reserva.user_id }
    end
  ...
  test "should update reserva" do
    put :update, id: @reserva, reserva: { area_id: @reserva.area_id, data: @reserva.data, status: @reserva.status, user_id: @reserva.user_id }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
