...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { comentavel_id: @comentario.comentavel_id, comentavel_type: @comentario.comentavel_type, conteudo: @comentario.conteudo, titulo: @comentario.titulo, user_id: @comentario.user_id }
    end
  ...
  test "should update comentario" do
    put :update, id: @comentario, comentario: { comentavel_id: @comentario.comentavel_id, comentavel_type: @comentario.comentavel_type, conteudo: @comentario.conteudo, titulo: @comentario.titulo, user_id: @comentario.user_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
