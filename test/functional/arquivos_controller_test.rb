...
class ArquivosControllerTest < ActionController::TestCase
  ...
  test "should create arquivo" do
    assert_difference('Arquivo.count') do
      post :create, arquivo: { descricao: @arquivo.descricao, residencial_id: @arquivo.residencial_id, titulo: @arquivo.titulo }
    end
  ...
  test "should update arquivo" do
    put :update, id: @arquivo, arquivo: { descricao: @arquivo.descricao, residencial_id: @arquivo.residencial_id, titulo: @arquivo.titulo }
    assert_redirected_to arquivo_path(assigns(:arquivo))
  end
